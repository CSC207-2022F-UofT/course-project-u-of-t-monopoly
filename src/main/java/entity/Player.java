...
public class Player {
    ...
    private ArrayList<TileCanBuy> tile = new ArrayList<TileCanBuy>();
...
//    }
    ...
    public void setTurnsInJail(int num) {
        this.turnsInJail = num;
    }

    /** Player spent 1 turn in jail.
     *
     */
    public void spentTurnInJail(){this.turnsInJail -= 1;}
